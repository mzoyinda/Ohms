        ...
        <TableBody>
          {audits.map((item) => (
            <tr key={item.id}>
              ...
              <td>
                Deleted <span className="highlight">{item.deletedItem}</span>{" "}
                from <span className="highlight">{item.DB}</span> Inventory
              </td>
              <td>
                24.03.2022 <span className="time"> 20:23 PM</span>
              </td>
            </tr>
          ))}
        </TableBody>
